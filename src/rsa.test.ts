...
describe('method', () => {  
  ...
  it('should accept RSA signature with hardcoded valid parameters', () => {
    const params = {
      n: BigInt('0x0086fa9ba066685845fc03833a9699c8baefb53cfbf19052a7f10f1eaa30488cec1ceb752bdff2df9fad6c64b3498956e7dbab4035b4823c99a44cc57088a23783'),
      e: 65537n,
      d: BigInt('0x5d2f0dd982596ef781affb1cab73a77c46985c6da2aafc252cea3f4546e80f40c0e247d7d9467750ea1321cc5aa638871b3ed96d19dcc124916b0bcb296f35e1'),
      p: BigInt('0x00c59419db615e56b9805cc45673a32d278917534804171edcf925ab1df203927f'),
      q: BigInt('0x00aee3f86b66087abc069b8b1736e38ad6af624f7ea80e70b95f4ff2bf77cd90fd'),
      dmp1: BigInt('0x008112f5a969fcb56f4e3a4c51a60dcdebec157ee4a7376b843487b53844e8ac85'),
      dmq1: BigInt('0x1a7370470e0f8a4095df40922a430fe498720e03e1f70d257c3ce34202249d21'),
      coeff: BigInt('0x00b399675e5e81506b729a777cc03026f0b2119853dfc5eb124610c0ab82999e45')
    }

    const message = Bigint2048.from(13n);
    const rsaSig = Bigint2048.from(BigInt('0x' + (bigInt(13n).modPow(params.d, params.n)).toString(16)));
